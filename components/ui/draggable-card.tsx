...
export const DraggableCardBody = ({
  ...
  return (
    <motion.div
      ...
      onMouseDown={(e) => {
        console.log('Mouse down on card from', e.target, 'at coordinates', e.clientX, e.clientY);
      }}
    ...
    >
      ...
      <div className="pointer-events-auto" style={{ pointerEvents: isDragging ? 'none' : 'auto' }}>
        {children}
      </div>
      <motion.div
        style={{
